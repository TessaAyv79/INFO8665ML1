...
ef send_email(to_email, subject, body):
    try:
        ...
        # Attaching the body with the message
...
# Feedback & Support Section in the Sidebar
st.sidebar.title('Feedback & Support')
st.sidebar.write("We value your feedback and are here to help you with any issues.")

# Feedback form in the sidebar
feedback_form = st.sidebar.form(key='feedback_form')
feedback_text = feedback_form.text_area('Share your feedback or report an issue:', height=150)
email_input = feedback_form.text_input('Your email (optional):')
submit_button = feedback_form.form_submit_button(label='Send Feedback')

if submit_button:
    if feedback_text.strip() == '':
        st.sidebar.error("Feedback cannot be empty. Please provide your feedback.")
    else:
        # Sending feedback to a designated email address (replace with your desired recipient)
        recipient_email = "recipient_email@example.com"  # Replace with your recipient email address
        subject = "User Feedback for Stock Seeker App"
        ...
        st.sidebar.success("Thank you for your feedback! We'll review it and take necessary actions.")
        if email_input.strip() != '':
            # Send email confirmation to the user if they provided their email address
            confirmation_subject = "Thank you for your feedback"
            confirmation_body = "Dear user,\n\nThank you for your feedback. We appreciate your input and will review it shortly.\n\nBest regards,\nThe Stock Seeker Team"
            send_email(email_input, confirmation_subject, confirmation_body)
