...
def prepare_data(ticker):
    ...
    df = stock_data.history(period='1y')  # Son 1 yılın verilerini alıyoruz
...
# Kullanıcıdan hisse senedi seçimi
selected_stocks = st.sidebar.multiselect(
    'Select stock ticker(s) for analysis',
        ...
        if checked:
            ...
            if option == "Stock Actions":
                ...
                for selected_stock in selected_stocks:
                    ...
                    train_and_evaluate_model(selected_stock, company_name)
                    train_and_evaluate_lstm_model(selected_stock, company_name)
                    train_and_evaluate_dnn_model(selected_stock, company_name)
