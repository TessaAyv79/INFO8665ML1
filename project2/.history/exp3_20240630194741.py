...
def get_company_names(popular_tickers):
    company_names = []
...
# Print or display the company names
...
def train_and_evaluate_lstm_model(selected_stock, start_date, end_date):
    st.subheader(f"{selected_stock} - Predicted Prices using LSTM Model")
    ...
    st.write(f"{selected_stock} - LSTM Model:")
