...
def send_email(feedback_text, user_email):
    sender_email = "your_email@example.com"  # Replace with your email address
    receiver_email = "recipient_email@example.com"  # Replace with recipient email address
    password = "your_password"  # Replace with your email password

    message = MIMEMultipart()
    message['From'] = sender_email
    message['To'] = receiver_email
    message['Subject'] = "Feedback from Stock Seeker Web App"
...
if submit_button:
    if feedback_text.strip() == '':
        ...
        send_email(feedback_text, email_input)
        if email_input.strip() != '':
            st.info(f"A confirmation email has been sent to {email_input}.")