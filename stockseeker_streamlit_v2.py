...
st.sidebar.title('About Stock Seeker')
st.sidebar.write("""
As IT professionals with a strong interest in data analysis, machine learning, and stock prediction, we have observed the significant challenges faced by amateur investors, particularly the financial losses they incur in the stock market. To address these issues, we initiated the Stock Seeker project. Our goal is to bridge the gap in accessing, analyzing, and interpreting real market data by leveraging advanced analytics and visualization techniques. With our expertise in AI and ML, combined with extensive software development experience, we have developed a sophisticated application designed for both professional and novice investors.

**Problem Statement:**
Over 75% of retail investors lose money in the stock market due to a lack of access to advanced analytics tools and reliable data (Chmiel, 2023). We identified significant barriers faced by amateur investors, including a lack of access to advanced analytics tools and reliable data, which leads to poor investment decisions and substantial financial losses. The financial market is complex and influenced by various factors such as socioeconomic conditions, political climates, and natural disasters, making accurate stock price predictions challenging.

**Target State:**
Create a robust and user-friendly system that collects and analyzes real-time market data, providing amateur investors with accurate and timely investment insights. This system aims to reduce the financial losses of retail investors by 50% by offering access to advanced analytics tools and reliable data. Existing tools are inadequate for real-time data processing and lack the accuracy required for rapid decision-making. Currently, over 75% of retail investors lose money in the stock market due to these limitations. The goal is to reduce this rate by 50%, addressing the critical need for better tools and methods to enhance investment outcomes.

**Calculation of Gap:**
- Current Loss Rate: 75% of retail investors lose money.
- Target Loss Rate: 37.5% reduction in losses.
- Desired Reduction in Losses: 75% - 37.5% = 37.5%

**Analyze the Root Cause:**
Using the "5 Whys" method, we determine that the lack of systematic and understandable graphical presentations for amateur investors stems from the inadequacies in existing tools and systems. The primary issue is the absence of a standardized approach for presenting market data in a way that is accessible to amateur investors. This issue arises because existing tools fail to offer user-friendly and intuitive graphical representations, largely due to their design focus on professional users who possess a certain level of expertise. Additionally, there is a gap in integrating real-time data with actionable and comprehensible visuals, as many systems either do not support real-time data feeds or struggle to present them effectively. This gap is further exacerbated by a lack of emphasis on designing visuals tailored for beginners, as the focus has traditionally been on developing advanced features for experienced traders rather than ease of use for amateurs. The root cause, therefore, is that existing tools are primarily designed for professional users and lack a focus on systematic, user-friendly graphical presentations and effective real-time data integration needed for amateur investors to make informed decisions.

**Objective:**
To address the significant barriers faced by amateur investors, such as inadequate access to advanced analytics tools and reliable data, which often lead to poor investment decisions and substantial financial losses, we aim to develop and implement the Stock Seeker web application. This application is designed to bridge the gap by providing accurate, real-time market data, utilizing advanced machine learning techniques for stock price prediction, and offering technical analysis tools to enhance decision-making. Our goal is to minimize financial losses and maximize investment opportunities for amateur investors through user-friendly and accessible analytics.

**Methodology:**
Our methodology involves enhancing investment decisions by integrating advanced data analysis and machine learning predictions. We begin by collecting historical stock price data for key technology stocks, such as NVDA, from reliable sources and then proceed with cleaning and preprocessing this data to ensure accuracy. Exploratory Data Analysis (EDA) and feature engineering are used to identify market patterns and trends. We develop and compare various machine learning models, including LSTM, Random Forest, and Gradient Boosting, to predict stock prices and evaluate their performance using metrics such as MSE, RMSE, MAE, and MAPE. These models are then integrated into the Stock Seeker web application, which provides real-time market data, technical analysis tools, and predictive insights. The effectiveness of the application is monitored through real-time feedback and performance metrics, aiming to reduce financial losses among investors by 50%.
""")

# Video demonstration of Stock Seeker
st.sidebar.title('Stock Seeker Demonstration')
st.sidebar.video("your_video_url_here")
