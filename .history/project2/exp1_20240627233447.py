...
def main():
    ...
    # Sidebar image
    st.sidebar.image("images/stock_market.jpg", use_column_width=True)

    # Date range selection with unique keys
    start_date = st.sidebar.date_input("Start Date", key="start_date_selector", value=updated_start_date)
    end_date = st.sidebar.date_input("End Date", key="end_date_selector", value=updated_end_date)
