...
# Clean Data process
def prepere_data(selected_stock):
    stock = pdr.get_data_yahoo(selected_stock, start=start, end=end)
...
def display_stock_analysis(selected_stock, analysis_type, start_date, end_date):
    stock_data = stock.Ticker(selected_stock)
...
def display_advanced_analysis(selected_stock, start_date, end_date):
    ...
    # Download historical data
    #df = yf.download(selected_stock, start=start_date, end=end_date)
    df = stock.download(selected_stock, start=start_date, end=end_date)
