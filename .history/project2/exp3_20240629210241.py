...
# Display the image with a container for overlay
with st.beta_container():
    st.image(image_path, use_column_width=True)
    st.markdown('<div style="text-align: center; color: white; font-size: 24px; font-weight: bold;">STOCK SEEKER WEB APP</div>', unsafe_allow_html=True)
