...
# Centered image with HTML and CSS
st.markdown(
    f"""
    <div style="text-align: center;">
        <img src="file://{r'C:\Users\Admin\Documents\MLAI\Stock_Prediction_Web_App_ML\docs\images\Screenshot 2024-06-28 183237.png'}" width="50%" />
    </div>
