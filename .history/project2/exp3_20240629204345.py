...
i# Centering the main image using HTML and CSS
st.markdown(
    f"""
    <div style="text-align: center;">
        <img src="file://{r'C:\Users\Admin\Documents\MLAI\INFO8665ML\project2\image\Screenshot 2024-06-28 183240.png'}" width="50%" />
    </div>
    """,
