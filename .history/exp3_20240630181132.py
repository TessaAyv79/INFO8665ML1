...
def train_and_evaluate_model(selected_stock, start_date, end_date):
    ...
    y = df['Adj Close']
    if all(col in df.columns for col in ['10_day_MA', '20_day_MA', '50_day_MA', 'Daily_Return']):
        X = df[['10_day_MA', '20_day_MA', '50_day_MA', 'Daily_Return']]
        # Continue with your modeling or processing logic here
    else:
        print("Columns '10_day_MA', '20_day_MA', '50_day_MA', 'Daily_Return' not found in DataFrame.")
