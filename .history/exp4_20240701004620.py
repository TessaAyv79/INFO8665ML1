...
def handle_analysis(selected_stock, analysis_type, start_date, end_date, df, validate_period):
...
if button_clicked:
    if selected_stocks:
        for selected_stock in selected_stocks:
            handle_analysis(selected_stock, analysis_type, start_date, end_date, df, validate_period)
    else:
