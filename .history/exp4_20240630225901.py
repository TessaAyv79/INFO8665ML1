        ...
        if checked:
            ...
            if option == "Stock Actions":
                ...
                for selected_stock in selected_stocks:
                    ...
                    train_and_evaluate_model(selected_stock, company_name, validated_period)
                    train_and_evaluate_lstm_model1(selected_stock, company_name, validated_period)
                    train_and_evaluate_dnn_model(selected_stock, company_name, validated_period)
